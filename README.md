...
Không đưa `.env` lên Git. Nếu không có khoá, ứng dụng chủ động chạy bằng lớp luật để demo giao diện. Node/Express được chọn vì khoá AI phải ở máy chủ, không lộ trong trình duyệt. Model mặc định là `gemini-3.1-flash-lite` để đáp ứng luồng tuần tự độ trễ thấp; Gemini 2.0 Flash đã ngừng hoạt động từ ngày 01/06/2026.
